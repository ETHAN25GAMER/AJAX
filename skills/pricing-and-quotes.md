...
## Tiers
- **Standard** — one-time treatment with a 30-day re-treatment guarantee. Best for mild to moderate infestations.
- **Plus** — recurring monthly plan. Covers the same pest category with regular scheduled visits and free callbacks between visits. Best value for recurring problems.
- **Specialist** — for severe infestations or structural concerns (e.g., termites, large rat colonies). Always requires an on-site inspection before we can confirm a price.
